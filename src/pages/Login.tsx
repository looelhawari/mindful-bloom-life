          ...
          <div className="bg-white px-4 py-8 shadow sm:rounded-lg sm:px-10">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <Link to="/forgot-password" className="font-semibold text-wellness-primary hover:text-wellness-primary/90">
                      Forgot password?
                    </Link>
                  </div>
                </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 text-center text-sm text-muted-foreground">
                Not a member?{' '}
                <Link to="/signup" className="font-semibold text-wellness-primary hover:text-wellness-primary/90">
                  Sign up now
                </Link>
              </div>
            </div>
